...
param searchServiceKey string // Set in main.parameters.json

param storageAccountName string = ''
param storageResourceGroupName string = ''
param storageResourceGroupLocation string = location
param storageContainerName string = 'content'
param storageDocumentContainerName string = 'document'
param storageSkuName string // Set in main.parameters.json
param storageAccountParam string // Set in main.parameters.json
...
param azureOpenAiKey string // set in main.parameters.json
...
param formRecognizerKey string // set in main.parameters.json
...
module backend 'core/host/appservice.bicep' = {
  ...
  params: {
    ...
    appSettings: {
      ...
      AZURE_STORAGE_ACCOUNT_KEY: storageAccountParam
      AZURE_STORAGE_CONTAINER: storageContainerName
      AZURE_STORAGE_DOCUMENT_CONTAINER: storageDocumentContainerName
      AZURE_SEARCH_INDEX: searchIndexName
      AZURE_SEARCH_SERVICE: searchService.outputs.name
      AZURE_SEARCH_SERVICE_KEY: searchServiceKey
      ...
      // Used for FormRecognizer
      AZURE_FORMRECOGNIZER_KEY: formRecognizerKey
...
module storage 'core/storage/storage-account.bicep' = {
  ...
  params: {
    ...
    containers: [
      ...
      {
        name: storageDocumentContainerName
        publicAccess: 'None'
      }
    ]
  }
...
output AZURE_FORMRECOGNIZER_KEY string = formRecognizerKey

output AZURE_SEARCH_INDEX string = searchIndexName
output AZURE_SEARCH_SERVICE string = searchService.outputs.name
output AZURE_SEARCH_SERVICE_RESOURCE_GROUP string = searchServiceResourceGroup.name
output AZURE_SEARCH_SERVICE_KEY string = searchServiceKey

output AZURE_STORAGE_ACCOUNT string = storage.outputs.name
output AZURE_STORAGE_ACCOUNT_KEY string = storageAccountParam
output AZURE_STORAGE_CONTAINER string = storageContainerName
output AZURE_STORAGE_DOCUMENT_CONTAINER string = storageDocumentContainerName
